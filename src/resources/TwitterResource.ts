...
export class TwitterResource {
  public static replaceShortURL(tweet: ITweet): ITweet {
    ...
    constructor(
        ...
        private apiPrefix: string = 'https://api.twitter.com',
    ) { }
    ...
    private async authorize() {
        const bearerTokenCredentials =
            encodeURIComponent(this.consumerKey) + ':' + encodeURIComponent(this.consumerSecret)
        const base64EncodedCredentials = '::' + Buffer.from(bearerTokenCredentials).toString('base64')
